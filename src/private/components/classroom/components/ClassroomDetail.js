  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', paddingVertical:20 }}>
      ...
      <View style={{ flex: 2, width: '100%', padding: 20 }}>
        ...
        <Text mt={2} style={{ ...style.text.sm}}>Progreso de la clase: 42%</Text>
        <Text mt={2} style={{ ...style.text.sm}}>Cantidad de alumnos: 32</Text>
        <Text mt={2} style={{ ...style.text.sm}}>Actividades creadas: 7</Text>
        <Text mt={2} style={{ ...style.text.sm}}>Actividades en curso: 2</Text>
        <Text mt={2} style={{ ...style.text.sm}}>Actividades finalizadas: 3</Text>
        <Text mt={2} style={{ ...style.text.sm}}>Calificación promedio: 18/20</Text>
      </View>
    </ScrollView>
  );
};
