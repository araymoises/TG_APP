...
const PrivateRouter = () => {
  ...
  return (
    <Tab.Navigator initialRouteName="ClassroomDetail" 
      ...
      <Tab.Screen name="ContentsList" component={ContentsList} options={{ headerShown: false, tabBarLabel: 'Contenidos', tabBarIcon: ({ color, size }) => (<Icon name="book" size={30} color={style.color.primary} /> ) }} />
    </Tab.Navigator>
  );
};
